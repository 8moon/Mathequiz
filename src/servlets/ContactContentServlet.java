...
@WebServlet(name = "ContactContentServlet")
public class ContactContentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        final RequestDispatcher requestDispatcher = request.getRequestDispatcher("html/maintenance/contactConfirmation.jsp");
        requestDispatcher.forward(request, response);
    }

    private void persist(ContactContent contactContent) throws ServletException {
        try (Connection connection = dataSource.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO contactcase (ContactMail, ContactFirstName, ContactLastName, ContactMessage) VALUES (?,?,?,?);")){
