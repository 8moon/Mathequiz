...
@WebServlet(name = "QuickGameCheckSolutionsServlet")
...
//        quickGameUserSolutions1.setRightUserSolutions(2);

        QuickGameExercises quickGameExercises1 = (QuickGameExercises) request.getSession().getAttribute("quickGameExercises1");


//        QuickGameExercises bean = (QuickGameExercises) request.getAttribute("quickGameExercises1");
...
//        request.getSession().setAttribute("quickGameUserSolutions1", quickGameUserSolutions1);


        RequestDispatcher dispatcher = request.getRequestDispatcher("html/gaming_pages/schnellesSpielPrüfung.jsp");
