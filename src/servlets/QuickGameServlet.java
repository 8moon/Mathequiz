...
@WebServlet(name = "QuickGameServlet")
public class QuickGameServlet extends HttpServlet {
//    private static final long serialVersionUID = 1L;

    private Random random = new Random();
    private int wert1, wert2, wert3, wert4, wert5, wert6, wert7, wert8, wert9, wert10, wert11, wert12, wert13, wert14, wert15, wert16, wert17, wert18, wert19, wert20;
    ...
    public void init() throws ServletException {
        ...
        wert18 = random.nextInt(50);

        wert19 = random.nextInt(50);
        wert20 = random.nextInt(50);
    }
...
//        session.removeAttribute("quickGameExercises1");
//        session.removeAttribute("quickGameUserSolutions1");
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("html/gaming_pages/schnellesSpielAusgabe.jsp");
        dispatcher.forward(request, response);
//        request.getRequestDispatcher("html/schnellesSpiel.jsp").forward(request, response);
    }
