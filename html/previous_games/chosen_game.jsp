...
<head>
	...
	<title>Mathequiz - Eines der letzten Spiele</title>
...
<body>
<header>
	<h1>Eines Ihrer letzten Spiele</h1>
...
<div id="flex_main_container">
	...
	<main>
		<h2>Hier sehen Sie eines Ihrer letzten zehn Spiele mit den
			dazugehörigen 10 Aufgabenstellungen sowie deren Lösungen</h2>
		<h3>Ausgewähltes Spiel</h3>
