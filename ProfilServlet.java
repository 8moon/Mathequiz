	...
	//	String dbpassword = user.getPassword();
		...
		try {
			...
			if (überprüfePassword(oldPassword, newPassword, passwordConfirmation) == true) {
				PreparedStatement pstm = conn.prepareStatement("UPDATE mathematikquiz.user"
				...
				final RequestDispatcher dispatcher = request.getRequestDispatcher("home/html/GleicherUsername.jsp");
		...
		final RequestDispatcher dispatcher = request.getRequestDispatcher("home/html/Mein.jsp");
		dispatcher.forward(request, response);
